...
IMPORTANT NOTE:
The extension only works with matrices made in a "column-zigzag pattern", starting in the top-left corner. meaning the matrix is made of strips in a zig-zag pattern going up and down. (These are the most common pre-made matrices, and can also easily be made using strips!()
